...
if (isset($_POST['btnbuscar'])) {
    ...
    $sqlusu = mysqli_query($conn, "SELECT pro.id, pro.nombre, descripcion, precio, cat.nombre as categoria 
        FROM productos pro, categoria_productos cat 
        WHERE pro.categoria_id = cat.id AND (
            pro.id LIKE '%$buscar%' OR
            pro.nombre LIKE '%$buscar%' OR
...
<div class="ContenedorTabla">
    <form method="POST">
        ...
        <div class="ContBuscar">
            <div style="float: left;">
                ...
                <input class="CajaTextoBuscar" type="text" name="txtbuscar" placeholder="Buscar por Id, Nombre, Descripción, Precio, Categoría" autocomplete="off">
            </div>
    ...
    <table>
        ...
        while ($mostrar = mysqli_fetch_assoc($sqlusu)) {
            ...
            <a class='BotonesTeam4' href=\"carrito.php?id=$mostrar[id]&pag=$pagina\">&#128722;</a>
            </td>";  
        }
        ?>
    </table>
